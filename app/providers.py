...
def demo_providers(slow: float = 0.0) -> dict:
    return {
        "supervisor": RoutedMock({
            "oscilloscope": [
                _call("ask_equipment", question="List oscilloscopes and tell me if I am trained for equipment 1"),
                ModelTurn(text="(mock) Digital Oscilloscope is equipment 1; your required training is complete."),
            ],
            "book equipment 2": [
                _call("ask_booking", request="Book equipment 2 for 2026-09-19 14:00 and send a confirmation."),
                ModelTurn(text="(mock) Equipment 2 is booked for 2026-09-19 14:00 and a confirmation was queued."),
            ],
        }, slow),
        "equipment": RoutedMock({
            "oscilloscope": [
                _call("list_equipment", text="oscilloscope"),
                _call("check_training", equipment_id=1),
                ModelTurn(text="(mock) Equipment 1 is the Digital Oscilloscope; training requirement oscilloscope_safety is satisfied."),
            ],
        }, slow),
        "booking": RoutedMock({
            "Book equipment 2": [
                _call("book_slot", equipment_id=2, slot="2026-09-19 14:00"),
                _call("notify_student", message="Your Raspberry Pi 5 Kit booking for 2026-09-19 14:00 is confirmed."),
                ModelTurn(text="(mock) Booked equipment 2 and queued the confirmation."),
            ],
        }, slow),
    }
